...
import 'package:gms_mobile/screen/fragment/absen/selectabsensi.dart';
...
class AbsenAllScreen extends StatefulWidget {
  const AbsenAllScreen({Key? key}) : super(key: key);

  @override
  _AbsenAllScreenState createState() => _AbsenAllScreenState();
}

class _AbsenAllScreenState extends State<AbsenAllScreen> implements AbsenState {
  String barcode = "";
  late String idUser = "";
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: FutureBuilder<List<ListAbsenModel>>(
                              future: ListAbsenService.getAll(idUser.toString()),
  ...
  void showstatusKondisi(BuildContext context) {
    ...
    //                                           _absenModel.longitude.toString(),
    //                                         );
    //                                         // _postAbsensi();
    //                                         Navigator.pop(context);
    //                                         showDialog(
